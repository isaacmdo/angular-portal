...
@Component({
  templateUrl: './configuration.stages.component.html',
  styleUrls: ['./configuration.stages.component.scss']
})
export class ConfigurationStagesComponent implements OnInit {
  config: AppConfig;
  items: MenuItem[];
  uploadedFiles: any[] = [];
  selectedCity1: any;
